...
# Set Operations
numbers_set = {x for x in numbers_list}
set2 = {5, 8}
...
try:
    with open("output.txt", "r") as file:
        content = file.read()
        largest_integer = max(map(int, content.split()))
except FileNotFoundError:
    print("Error: output.txt file not found.")
    exit(1)
except ValueError:
    print("Error: No integers found in output.txt.")
    exit(1)
...
print("List of prime numbers up to", largest_integer, ":")
print(prime_numbers)
print("Sum of prime numbers:", prime_sum)
print("Largest prime number:", largest_prime)
print("Smallest prime number:", smallest_prime)
print("Is the largest integer prime?", "Yes" if largest_is_prime else "No")

with open("prime_numbers.txt", "w") as file:
    file.write("List of prime numbers up to " + str(largest_integer) + ":\n")
    ...
    file.write("Is the largest integer prime? " + ("Yes" if largest_is_prime else "No") + "\n")
'''10.
